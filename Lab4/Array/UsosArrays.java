...
public class UsosArrays {
    ...
    private static String arrayString[] = {"casa","arbol","zapato","balón"};
    ...
    public static void main(String args[]) {
        ...
        Arrays.sort(arrayDouble); //ordenando ascendente
    ...
    public static void imprimirArrays() {
        ...
        System.out.print("\narrayString: ");
        for (String valorString : arrayString) {
            System.out.printf("%s ", valorString);
        }
